...
public class ResearchDBConnection {
    ...
    private static final ResearchDBConnection INSTANCE;

    static {
        try {
            INSTANCE = new ResearchDBConnection();
        } catch (DataLayerException e) {
            throw new ExceptionInInitializerError(e);
        }
    }

    private ResearchDBConnection() throws DataLayerException{
        try{
            connect();
        } catch (DataLayerException dle) {
            throw new DataLayerException(dle, getCurTime(), "ResearchDbConnection:ResearchDbConnection");
        }
    }
